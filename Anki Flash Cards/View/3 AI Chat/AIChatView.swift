...
struct AIChatView: View {
    ...
    @ObservedObject var appNavVM: AppNavigationVM
    ...
    @AppStorage("isFirstOpenChatKey") var isFirstOpenChat = false
    ...
    var body: some View {
                ...
                HStack {
                    TextField("Type your message...", text: $viewModel.currentInput)
                        ...
                        .onChange(of: isTextFieldFocused) { newValue in
                            appNavVM.isTabBarVisible = !newValue
                        }
        ...
        .onAppear {
            ...
            do {
                ...
                print("Error setting up Core Data for chat: \(error)")
            }
        }
    }
}
