...
final class DesignVM: ObservableObject {
    ...
    */
    ...
    // Title "Sets"
    @Published var color_title_sets: Color = Color.black.opacity(0.7)
    // Cell Sets
    ...
    @Published var color_back_cell_set_home = Color(hex: "#546a50").opacity(0.000000001)
    @Published var color_overlay_cell_set_home = Color(hex: "#546a50").opacity(0.2)
    // Add Collection Button
    @Published var color_back_button_add_collection_home = Color(hex: "FBDA4B")
