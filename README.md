...
В приложении данные хранятся в Core Data для прогресса и JSON-файлах для слов и тем. Подход гибридный: Core Data отвечает за состояние пользователя, JSON — за контент курсов. Это позволяет легко добавлять новые языки без миграции базы.
